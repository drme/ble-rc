...
#elif defined (FIRMWARE_TYPE_MINIZ)
	static const uint8 devInfoHardwareRev[]  = "Mini-Z";
#else
	#error "undefined type"
#endif

#if defined(HAL_IMAGE_A)
	static const uint8 devInfoFirmwareRev[]  = "1.0.0 - A";
#elif defined(HAL_IMAGE_B)
	static const uint8 devInfoFirmwareRev[]  = "1.0.0 - B";
#else
	static const uint8 devInfoFirmwareRev[]  = "1.0.0 - 0";
#endif

static const uint8 devInfoSerialNumber[] = "("__DATE__" "__TIME__")";
...
CONST gattServiceCBs_t devInfoCallBacks ={ DevInfoReadAttributeCallBack, NULL, NULL };

bStatus_t DevInfo_AddService(void)
{
	return GATTServApp_RegisterService(devInfoAttrTbl, GATT_NUM_ATTRS(devInfoAttrTbl), &devInfoCallBacks);
};
